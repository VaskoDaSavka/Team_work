...
<div class="container" style="margin-top: 40px; max-width: 85%;">
    ...
    <div class="news-form" style="background: #ffffff; padding: 20px; border-radius: 15px; border: 3px solid #8A2BE2; margin-bottom: 30px; max-width: 100%; margin-left: auto; margin-right: auto;">
        ...
        <form method="POST" action="/news">
            <div class="form-group" style="margin-bottom: 15px;">
                ...
                <input type="text" name="title" id="title" class="form-control" value="{{ form_data['title'] }}" style="border-radius: 5px; border: 2px solid #8A2BE2;">
            </div>
            <div class="form-group" style="margin-bottom: 15px;">
                <label for="author" style="font-family: 'Comic Sans MS', cursive, sans-serif; color: black;">Author</label>
                <input type="text" name="author" id="author" class="form-control" value="{{ form_data['author'] }}" style="border-radius: 5px; border: 2px solid #8A2BE2;">
            </div>
            <div class="form-group" style="margin-bottom: 15px;">
                <label for="description" style="font-family: 'Comic Sans MS', cursive, sans-serif; color: black;">Description</label>
                <textarea name="description" id="description" class="form-control" rows="5" style="border-radius: 5px; border: 2px solid #8A2BE2;">{{ form_data['description'] }}</textarea>
            </div>
            <div class="form-group" style="margin-bottom: 15px;">
                <label for="date" style="font-family: 'Comic Sans MS', cursive, sans-serif; color: black;">Date (DD.MM.YYYY)</label>
                <input type="text" name="date" id="date" class="form-control" value="{{ form_data['date'] }}" style="border-radius: 5px; border: 2px solid #8A2BE2;">
            </div>
